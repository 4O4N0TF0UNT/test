...
public class AddClassesServlet extends HttpServlet { //AddClassesServlet类继承HttpServlet类
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		classes.setName(request.getParameter("cla_name"));//后台通过request.getParameter("元素中的cla_name值")获取数据
